...
if [[ -f "strategies/cexio.$1-USD_$2_data.json" && -z "$4" ]]; then
  ...
  echo "Running command ./scripts/genetic_backtester/darwin.js --days=$3 --asset_capital=0 --currency_capital=1000 --selector=\"cexio.$1-USD\" --population=100 --use_strategies=\"$2\"  --population_data=\"strategies/cexio.$1-USD_$2_data.json\""
